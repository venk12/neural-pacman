    ...
    try:
        while True:
            ...
            if event_id == [-2]:
                ...
                # Save to a .npz file
                np.savez('task_markers.npz', event_ids=event_ids, timestamps=timestamps)
...
def read_signal_stream(device_name, buffer, stop_event, save_interval=2, save_path="buffer_data"):
